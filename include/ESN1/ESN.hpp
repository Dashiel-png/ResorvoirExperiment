...
class ESN{
    ...
    double param; //density paramter, default to 1
    ...
    public:
    ESN(int dim, Activation& f, double p  = 1.0, VectorXd& init); //will initialise class weights W_con with density p, and then normalise
